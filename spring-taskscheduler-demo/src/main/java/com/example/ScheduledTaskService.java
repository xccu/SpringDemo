...
public class ScheduledTaskService {
	...
	void FixedDelayStringRun() {
		log.info("FixedDelayStr：\t读取配置文件执行" + System.currentTimeMillis());
	}*/
	...
	void initialDelayRun() {
		log.info("initialDelay：\t\t延迟10秒执行" + System.currentTimeMillis());
	}
	...
	void initialDelayStringRun() {
		log.info("initialDelayStr：\t延迟10秒执行" + System.currentTimeMillis());
	}*/
}
